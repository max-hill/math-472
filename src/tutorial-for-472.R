...
# OPTIONAL EXERCISE: what happens as we increase the number of replicates from
# 40 to 400? To 4000? To 40000? To 4,000,000? Explain why your observations
# make sense, in the context of the law of large numbers.

# OPTIONAL EXERCISE: answer the previous question, but sample the balls
# without replacement. Do the averages agree?
...
# our dice does not need to be a fair dice. For example, if we want to
# implement an unfair dice that rolls 6 slightly more often and 1 slightly
# less often, we can do so as follows:

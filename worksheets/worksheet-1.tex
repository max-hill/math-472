...
\begin{problem}[2-dimensional Brownian motion]
  ...
  slowly move around in a random, irregular way.
  ...
  \begin{enumerate}[(a)]
    ...
    \item \label{item:4} With $\sigma=1/100$, let $D$ be the distance of the
    pollen grain from the origin after $10000$ time steps. Generate a large
    number of independent samples of $D$. Use them to estimate the mean and
    variance of $D$, and plot a histogram of your $D$ values.

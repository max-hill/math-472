...
\begin{problem}[Exercise 8.8 in the textbook]
  ...
  \begin{equation*}
    \widehat{\theta}_{1} =Y_{1}, \quad\quad \widehat{\theta}_{2}= \frac{Y_{1}+Y_{2}}{2}, \quad\quad \widehat{\theta}_{3} = \frac{Y_{1}+2Y_{2}}{3}, \quad\quad \widehat{\theta}_{4} = \min(Y_{1},Y_{2},Y_{3}), \quad\quad \widehat{\theta}_{5}= \overline{Y}
  \end{equation*}

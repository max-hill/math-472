...
\begin{problem}[Exercise 10.21]
  ...
  Shear strength measurements derived from unconﬁned compression tests for two
  ...
  1\% signiﬁcance level? \textit{[Hint: see example 10.7 in the textbook.]}

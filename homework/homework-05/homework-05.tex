...
adults were given the ﬁrst pain reliever, and 93\% indicated appreciable pain relief. Of the 450
...
\begin{problem}[Exercise 8.15]
  ...
  \begin{enumerate}[(a)]
    \item What is the bias of $\widehat{\beta}$? Simplify your answer.
    \item What is $\text{MSE}(\widehat{\beta})$? You don't need to simplify
    your answer.
  \end{enumerate}
\end{problem}

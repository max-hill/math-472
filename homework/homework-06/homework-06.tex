...
\begin{problem}[Exercise 8.50]
  ...
  were used to denote the proportions of refrigerator of brands $A$ and $B$,
  ...
  \begin{enumerate}[(a)]
    ...
    \item At the approximate 98\% conﬁdence level, what is the smallest
    ``believable value'' for the difference in the proportions of failures for
    refrigerators of brands $A$ and $B$? 
...
\begin{problem}[Exercise 8.81]
  The carapace lengths (in mm) of ten lobsters examined in a study of the
...
\begin{problem}[Exercise 8.85]
  Two new drugs were given to patients with hypertension. The ﬁrst drug
  ...
  points. Determine a 95\% conﬁdence interval for the difference in the
...
\begin{problem}[Exercise 9.24]
  ...
  \begin{enumerate}[(a)]
    \item What is the distribution of $\sum_{i=1}^{n} Y_{i}^{2}$?
...
\begin{problem}[Exercise 9.39]
  ...
  with parameter $\lambda$.  Show that $\sum_{i=1}^{n} X_{i}$ is sufficient
  for $\lambda$. 
\end{problem}

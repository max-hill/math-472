...
\end{equation*}
(where we've used the sample standard devation $S$ in place of the unknown
population paramter $\sigma$).
...
\textit{This part is based on Chapter 8.8 in the textbook.}
...
\begin{example}[Example 8.11 in the textbook]
  The muzzle velocity of an An artillery  shell 

  \begin{align*}
    &1062 \quad \ 965 \quad  \ 982\\
    &1006  \quad \ 960 \quad 1056
  \end{align*}
\end{example}

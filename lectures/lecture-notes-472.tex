...
\newpage
\section{2026-02-09 | Week 05 | Lecture 12}
...
\begin{proposition}
  Suppose $\widehat{\theta}$ is an unbiased estimator of $\theta$, and let
  $\epsilon=|\widehat{\theta}-\theta|$ be the estimation error. Then
  \begin{equation*}

...
\begin{remark}
  ...
  accounting for the higher variance that $\overline{Y}$ has due our small
  sample size. As the result, the interval wouldn't truly be a 95\% interval.
  It might actually be an 80\% interval or something---so our confidence in
  our estimate would be misplaced.
\end{remark}
...
\begin{example}[Example 9.1 in the textbook]
  ...
  \begin{claimproof}
    ...
    \end{equation*}
    Differentiating $F$ implies the claim.
  \end{claimproof}
